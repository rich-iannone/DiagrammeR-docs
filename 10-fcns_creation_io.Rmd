...
<img src="diagrams/create_node_df.svg">
...
<img src="diagrams/create_edge_df.svg">
...
<img src="diagrams/combine_ndfs.svg">
...
<img src="diagrams/combine_edfs.svg">
...
<img src="diagrams/create_graph.svg">
...
<img src="diagrams/create_random_graph.svg">
...
<img src="diagrams/combine_graphs.svg">
...
**`y`** a `DiagrammeR` graph object that is to be unioned with the graph suppled as `x`.

## `import_graph()`

<h4><em>Import a graph from various graph formats</em></h4>

<img src="diagrams/import_graph.svg">
